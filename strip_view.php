...
foreach ($stripboeken as $stripboek) {
    echo "<tr><td>".$stripboek->getHeld() . "</td><td>" . $stripboek->getTitle() ."</td><td>". $stripboek->getDeel() ."</td><td>".$stripboekLader->findTekenaarById($stripboek->getTekenaar()) ."</td><td>" . $stripboek->getJaaruitgave() ."</td></tr>";
}
echo "</table>";
